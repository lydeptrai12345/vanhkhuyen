				...
				<div class="card-body p-0 pb-3 text-center">
					<table class="table mb-0">
						...
						<?php
                            ...
                            $query = "SELECT * FROM phongban ORDER BY phong_ban_id ASC LIMIT {$start},{$limit}";
                            $results = mysqli_query($dbc, $query);
						...
						<tbody>
							<tr>
								...
								<td>
									<a href="admin-phongban-xoa.php?id=<?php echo $item['phong_ban_id']; ?>" onclick="return confirm('Bạn có thực sự muốn xóa không <?php echo $item['ten']; ?>');"><i class="material-icons action-icon">delete_outline</i></a>
								</td>
							</tr>
						</tbody>
						<?php } ?>
