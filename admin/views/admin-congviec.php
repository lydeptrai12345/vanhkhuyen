...
<?php
    $data_phan_quyen = kiem_tra_quyen_nguoi_dung(17);
?>
				...
				<div class="card-header border-bottom">
					<form action="admin-congviec.php" method="get">
                        ...
                        <?php if($data_phan_quyen->them): ?>
                            <button id="btn-show-add-nien-khoa" type="submit" name="them" class="btn btn-success">Thêm chức vụ</button>
                        <?php endif; ?>
					</form>
				</div>
                ...
                table = $('#tripRevenue').DataTable({
                    ...
                    columnDefs: [
                        ...
                        { targets: 2, className: 'dt-body-center' },
                        {
                            ...
                            defaultContent: '<a class="edit-btn '+ ((phan_quyen.sua == 0) ? 'd-none' : '') + '" data-action="1" style="cursor: pointer" title="Cập nhật chức vụ"><i class="material-icons action-icon">edit</i></a> ' +
                                '<a data-action="2" class="delete-btn '+ ((phan_quyen.xoa == 0) ? 'd-none' : '') +'" style="cursor: pointer" title="Xóa chức vụ"><i class="material-icons action-icon">delete_outline</i></a>'
                        }
                    ],
                    columns: [
                        { width: "30px" },
