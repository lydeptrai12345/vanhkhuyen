            ...
            <div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default" id="heading1">
                    <div class="panel-heading" data-toggle="collapse" data-target="#collapse1"
                        ...
                        <h4 class="panel-title"><span class="glyphicon glyphicon-file"
                                                      style="margin-right: 6px; top: 2px"></span>
                            Quản lý tin tức
                        </h4>
                    ...
                    <div id="collapse1" class="panel-collapse collapse" aria-labelledby="heading1"
                         data-parent="#accordion">
                        <ul class="list-group">
                            <a class="list-group-item cus-collapse-item" href="admin-loaitin.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Loại tin</a>
                            <a class="list-group-item cus-collapse-item" href="admin-hoatdong.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Hoạt động </a>
                            <a class="list-group-item cus-collapse-item" href="admin-tintuc.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Tin tức </a>
                        </ul>
                    </div>
                </div>
                    ...
                    <a href="#" class="parent-active"
                       style="text-decoration: none; display: block;line-height: 2;color:black;background:#f5f5f5">
                        <div class="panel-heading" data-toggle="collapse" data-target="#collapse2"
                            ...
                            <div class="panel-title"><span class="glyphicon glyphicon-print"
                                                           style="margin-right: 6px; top: 2px"></span> Quản lý thiết bị
                            </div>
                        </div>
                    </a>
                ...
                <div class="panel panel-default" id="heading3">
                    <a href="admin-quanlyluong.php" class="parent-active"
                       style="text-decoration: none; display: block;line-height: 2;color:black;background:#f5f5f5">
                        <div class="panel-heading" data-toggle="collapse" data-target="#collapse3"
                             aria-controls="collapse3">
                            <div class="panel-title"><span class="glyphicon glyphicon-list-alt"
                                                           style="margin-right: 6px; top: 2px"></span> Quản lý lương
                            </div>
                        </div>
                    </a>
                ...
                <div class="panel panel-default" id="heading4">
                    <div class="panel-heading" data-toggle="collapse" data-target="#collapse4"
                        ...
                        <h4 class="panel-title">
                            <span class="glyphicon glyphicon-briefcase" style="margin-right: 6px; top: 2px"></span>
                            Quản lý cấp dưỡng
                        </h4>
                    ...
                    <div id="collapse4" class="panel-collapse collapse" aria-labelledby="heading4"
                         data-parent="#accordion">
                        <ul class="list-group">
                            <a class="list-group-item cus-collapse-item" href="admin-len-menu.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Lên menu</a>
                            <a class="list-group-item cus-collapse-item" href="admin-nhap-nguyen-lieu.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Nhập nguyên liệu</a>
                        </ul>
                    </div>
                </div>
                <div class="panel panel-default" id="heading5">
                    <div class="panel-heading" data-toggle="collapse" data-target="#collapse5"
                        ...
                        <h4 class="panel-title"><span class="glyphicon glyphicon-education"
                                                      style="margin-right: 6px; top: 2px"></span>
                            Quản lý đào tạo
                        </h4>
                    ...
                    <div id="collapse5" class="panel-collapse collapse" aria-labelledby="heading5"
                         data-parent="#accordion">
                        <ul class="list-group">
                            <a class="list-group-item cus-collapse-item" href="admin-be.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Quản lý bé</a>
                            <a class="list-group-item cus-collapse-item" href="admin-lop.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Quản lý lớp</a>
                            ...
                            <a class="list-group-item cus-collapse-item" href="admin-quan-ly-hoc-phi.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Quản lý học phí</a>
<!--                            <a class="list-group-item cus-collapse-item" href="admin-danh-sach-hoc-phi.php"><span-->
<!--                                        class="glyphicon glyphicon-menu-right"-->
<!--                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Danh sách học-->
<!--                                phí</a>-->
                        </ul>
                    </div>
                </div>
                ...
                <div class="panel panel-default" id="heading6">
                    <div class="panel-heading" data-toggle="collapse" data-target="#collapse6"
                        ...
                        <h4 class="panel-title"><span class="glyphicon glyphicon-user"
                                                      style="margin-right: 6px; top: 2px"></span>
                            Quản lý hành chính
                        </h4>
                    ...
                    <div id="collapse6" class="panel-collapse collapse" aria-labelledby="heading6"
                         data-parent="#accordion">
                        <ul class="list-group">
                            <a class="list-group-item cus-collapse-item" href="admin-nhanvien.php">
                                <span class="glyphicon glyphicon-menu-right" style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>
                                Quản lý nhân viên
                            </a>
                            <a class="list-group-item cus-collapse-item" href="admin-bangcap.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Bằng cấp</a>
                            <a class="list-group-item cus-collapse-item" href="admin-congviec.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Chức vụ</a>
                            <a class="list-group-item cus-collapse-item" href="admin-phongban.php"><span
                                        class="glyphicon glyphicon-menu-right"
                                        style="top: 0.5px;margin-right: 5px;font-size: 12px"></span>Phòng ban</a>
                        </ul>
                    </div>
                </div>
            </div>
