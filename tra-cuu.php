...
<section class="junior__classes__area section-lg-padding--top section-padding--md--bottom bg--white" style="padding-top: 40px">
    <div class="container">
        ...
        <form action="tra-cuu.php" method="GET" class="row">
            ...
            <div class="col-md-6">
                <input autocomplete="off" name="keyword" value="<?php if(isset($_GET['keyword'])) echo $_GET['keyword'];?>" placeholder="Nhập thông tin bé để tra cứu" type="text" maxlength="255" class="form-control">
            </div>
            <div class="col-md-2">
                        ...
                        <div class="row ket-qua" >
                            <div class = col-3>
                                <a href="" class="a-chua-img">
                                    <img src="admin/images/hinhbe/<?php echo $item['hinhbe']?>" style="width: 100px; height: 120px;">
                                </a>
                            </div>
